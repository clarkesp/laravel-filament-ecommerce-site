...
export default {
    ...
    theme: {
        extend: {
            ...
            backgroundImage: {
                'hero-pattern': "url('/Users/heathclarke/StormPro/Noddie_logos/background_design.svg')",
                'footer-texture': "url('/Users/heathclarke/StormPro/Noddie_logos/background_design.svg')",
                'custom-pattern': "url('/Users/heathclarke/StormPro/Noddie_logos/background_design.svg')",
            },
        },
