            ...
            <div class="px-4 py-4 mx-auto max-w-7xl lg:py-6 md:px-6">
                <div class="flex flex-wrap mb-24 -mx-3">
                    <div class="w-full pr-2 lg:w-1/4 lg:block">
                        <!-- Categories -->
                        <div class="p-4 mb-5 bg-white border border-gray-200 dark:border-gray-900 dark:bg-gray-900 rounded-md">
                        ...
                        <!-- Brands -->
                        <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900 rounded-md">
                        ...
                        <!-- Product Status (Featured and On Sale) -->
                        <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900 rounded-md">
                            ...
                            <ul>
                                <li class="mb-4">
                                    <label for="featured" class="flex items-center dark:text-gray-300">
                                        <input type="checkbox" id="featured" wire:model.live="featured" value="true" class="w-4 h-4 mr-2">
                                        <span class="text-lg dark:text-gray-400">In Featured</span>
                                    </label>
                                </li>
                                <li class="mb-4">
                                    <label for="onSale" class="flex items-center dark:text-gray-300">
                                        <input type="checkbox" id="onSale" wire:model.live="onSale" value="true" class="w-4 h-4 mr-2">
                    ...
                    <div class="w-full px-3 lg:w-3/4">
                        ...
                        <div class="px-3 mb-4">
{{--                            <div class="items-center justify-between px-3 py-2 bg-gray-100 md:flex dark:bg-gray-900 rounded-md border border-black">--}}
                            <div>
                                <div class="flex items-center justify-between">
                                    <select wire:model.live="sort" class="block w-56 text-base bg-gray-100 cursor-pointer dark:text-gray-400 dark:bg-gray-900 rounded-md border border-black">
...
{{--                        this block will allow the placeholder image to be set if no product image is up loaded--}}
                            ...
                            @foreach($products as $product)
                                <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire:key="product-{{ $product->id }}">
                                    <div class="border border-gray-300 dark:border-gray-700 rounded-md">
                                        <div class="relative bg-gray-200 dark:bg-gray-700 rounded-t-md">
                                            <a href="/products/{{$product->slug}}" class="">
                                                @if(!empty($product->images) && isset($product->images[0]))
                                                    <img src="{{ url('storage', $product->images[0]) }}" alt="{{ $product->name }}" class="object-cover w-full h-56 mx-auto rounded-t-md">
                                                @elseif(!empty($product->user) && !empty($product->user->profile_image))
                                                    <img src="{{ url('storage', $product->user->profile_image) }}" alt="{{ $product->user->name }}" class="object-cover w-full h-56 mx-auto rounded-t-md">
                                                @else
                                                    <img src="{{ url('path-to-placeholder-image/placeholder.jpg') }}" alt="Placeholder image" class="object-cover w-full h-56 mx-auto rounded-t-md">
                                                @endif
                                            </a>
                                        </div>
                        ...
                        <span class="text-green-600 dark:text-green-400">
                            ${{ number_format($product->price, 2) }}
                                        ...
                                        <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700 dark:bg-gray-800 rounded-b-md">
...
{{--                            <div class="bg-white border border-gray-200 dark:border-gray-900 dark:bg-gray-900 rounded-md p-3">--}}
{{--                                {{ $products->links() }}--}}
{{--                            </div>--}}
{{--                        </div>--}}
                        <div class="flex justify-end mt-6">
